...
[Dã Kauã da Luz Lopes](https://github.com/Dakaua)
...
Este projeto se trata de um portal de noticias onde anunciamos novas noticias. Vale ressaltar que esse projeto se trata de um trabalho para nosso curso técnico de TI, portanto, muitas das informações aqui são fictícias. 
